...
APPTAINER_BIND="/project/6079231/dliang55/R01_AOCD:/project/6079231/dliang55/R01_AOCD,/scratch/xxqian:/scratch/xxqian, /scratch/xxqian/repo/OCD_RO1/PCC_ROI_1st.py:/app/PCC_ROI_1st.py"
...
if [ -n "\$SUBJECT" ]; then
    apptainer exec --bind "${APPTAINER_BIND}" "${CONTAINER}" python3 /app/PCC_ROI_1st.py --subject sub-\${SUBJECT}
else

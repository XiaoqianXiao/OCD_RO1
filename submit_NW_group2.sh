...
# Bind directories
APPTAINER_BIND="/scratch/xxqian/repo/OCD_RO1/NW_group2.py:/app/NW_group2.py,${SCRATCH_DIR}/OCD:/output,${PROJECT_DIR}/metadata:/metadata,${CLINICAL_CSV}:/clinical.csv,${SUBJECTS_CSV}:/subjects.csv,${INPUT_DIR}:/input"
